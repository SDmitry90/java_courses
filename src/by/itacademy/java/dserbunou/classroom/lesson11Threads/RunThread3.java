...
public class RunThread3 {
    ...
    private static void callMethodThenOthers(int firstMethodIndex) throws InterruptedException {
        ...
        RunThread3 objectInstance = new RunThread3();
     ...
     */
    private static void runInNewThread(int methodIndex, RunThread3 objectInstance) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                Method method;
                try {
                    method = RunThread3.class.getMethod("test" + methodIndex);

...
public class Test2 {
    ...
    // Дана древовидная структура данных. Каждый узел дерева - класс Employee,
    // который имеет 2 свойства:
    // - List<Employee> subordinates;
    // - int age;

    // Сгенерировать дерево , где age определяется как случайное целое число от 20
    // до 60, а количество subordinates, как случайное целое число от 0 до 10. При
    // построении дерева параллельно распечатать его структуру в консоль любым
    // способом. Максимальная вложенность дерева =5

    // После построения дерева посчитать средний возраст всех сотрудников.
